...
type SetupProps = {
  handleStart: (arxivUrl: string) => void;
};
...
export const Setup: React.FC<SetupProps> = ({ handleStart }) => {
  const [state, setState] = React.useState<"intro" | "setup" | "loading">("intro");
          ...
          {state === "intro" ? (
            <>
              <p className="text-gray-600 leading-relaxed text-pretty">
                This app demos a voice-controlled storytelling chatbot that creates stories based on academic papers.
                Enter an arXiv paper URL, and the bot will create an engaging story that explains the concepts from the paper.
                After each scene, the bot will pause to ask for your input.
              </p>
              <div className="flex flex-col gap-2">
                <label htmlFor="arxiv-url" className="text-gray-600 font-medium">
                  arXiv Paper URL:
                </label>
                <input
                  id="arxiv-url"
